    ...
    async function fetchCourses() {
      ...
      try {
        const { data, error: sbError } = await supabase
          ...
          .eq("university_id", TAYLORS_UNIVERSITY_ID);
      ...
      <div className="bg-gradient-to-br from-purple-900 via-purple-800 to-purple-700 text-white pt-12 pb-16 px-4">
        <div className="max-w-5xl mx-auto">
          <button
            ...
            className="flex items-center gap-2 text-purple-200 hover:text-white transition-colors mb-6 group"
          >
          ...
          <div className="flex items-center gap-4 mb-4">
            ...
            <div>
              <div className="inline-block bg-purple-500/40 border border-purple-400/40 rounded-full px-3 py-0.5 text-xs font-semibold text-purple-100 mb-1">
                جامعة خاصة · Top Ranked
              </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            ...
            <div className="relative">
              ...
              <select
                ...
                className="w-full border border-gray-200 rounded-xl py-2.5 pr-9 pl-3 text-sm focus:outline-none focus:ring-2 focus:ring-purple-500 focus:border-transparent appearance-none bg-white transition"
              >
            ...
            <div className="relative">
              ...
              <select
                ...
                className="w-full border border-gray-200 rounded-xl py-2.5 pl-9 pr-3 text-sm focus:outline-none focus:ring-2 focus:ring-purple-500 focus:border-transparent appearance-none bg-white transition text-left"
              >
          ...
          <>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-8">
              {paginated.map((course) => (
                <div
                  key={course.id}
                  className="bg-white border border-gray-100 rounded-2xl p-5 hover:shadow-md hover:border-purple-200 transition-all"
                >
                  <h3 className="font-bold text-gray-900 text-base leading-snug mb-1">
                    {course.name}
                  </h3>
                  <p className="text-purple-700 text-sm font-medium mb-4">
                    {course.universities?.[0]?.name ?? "Taylor's University"}
                  </p>
